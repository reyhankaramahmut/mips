...
const UChar bit_mask[5] = {BIT1, BIT0, BIT1, BIT2, BIT3};
const TEvent event[5] = {EVENT_BTN1, EVENT_BTN3, EVENT_BTN4, EVENT_BTN5, EVENT_BTN6};

// Arrays to store the counters and states for the buttons
static UChar cnt_state[5];
